...
- `#[mmio(RW)]`: The field is read-write. This is the default.
- `#[mmio(RO)]`: The field is read-only. Only the `read_*` API will be generated by the macro.
...
#[error("out of bounds at index {0}")]
